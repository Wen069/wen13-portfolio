...
export class Whispers
{
    ...
    setMenu()
    {
        ...
        this.menu.input.addEventListener('input', () =>
        {
            ...
            this.menu.previewMessageText.textContent = sanatized.length ? sanatized : '在这里留下消息'
        ...
        {
            const sanatized = sanatize(this.menu.input.value, true, true, true)
            this.menu.previewMessageText.textContent = sanatized !== '' ? sanatized : '在这里留下消息'
            updateGroup()
        })
        ...
        {
            this.menu.previewMessageText.textContent = '在这里留下消息'
