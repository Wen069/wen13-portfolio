...
export class LandingArea extends Area
{
    ...
    setLetters()
    {
        ...
        {
            const originalObject = reference.userData.object
            originalObject.visual.parent = null
            originalObject.visual.object3D.visible = false
        ...
        for(const model of models)
        {
            const letterObject = this.game.objects.addFromModel(
                ...
                {},
                {
                    ...
                    sleeping: true,
                    mass: model.userData.mass ?? 1,
                }
            )

            this.objects.items.push(letterObject)

            const physical = letterObject.physical
