...
export class ProjectsArea extends Area
{
    ...
    setTexts()
    {
        ...
        this.texts.fontFamily = 'Noto Sans SC'
        this.texts.fontWeight = 700
        this.texts.fontSizeMultiplier = 0.72
    ...
    setUrl()
    {
        ...
        this.url.open = () =>
        {
            ...
            {
                if(this.navigation.current.url.startsWith('#'))
                    window.location.hash = this.navigation.current.url.slice(1)
                else
