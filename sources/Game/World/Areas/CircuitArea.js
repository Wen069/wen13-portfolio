...
export class CircuitArea extends Area
{
    ...
    setTimer()
    {
        ...
        // Digits
        {
            ...
            // Canvas
            const font = `700 ${this.timer.digits.height}px "Noto Sans SC", "Nunito", sans-serif`
    ...
    setLeaderboard()
    {
        ...
        // Canvas
        const font = `700 ${resolution / 14}px "Noto Sans SC", "Nunito", sans-serif`
        ...
        this.leaderboard.update = (scores = null) =>
        {
            const draw = () =>
            {
                ...
                if(scores === null)
                {
                    ...
                    context.textBaseline = 'middle'
                    context.textAlign = 'center'
                    context.fillText('离线', resolution * 0.5, resolution * 0.5)
                }
                else if(scores.length === 0)
                {
                    ...
                    context.textBaseline = 'middle'
                    context.textAlign = 'center'
                    context.fillText('今天还没有成绩', resolution * 0.5, resolution * 0.5)
                }
                else
                {
                    context.font = font
    ...
    setResetTime()
    {
        ...
        // Canvas
        const font = `700 ${height / 1.75}px "Noto Sans SC", "Nunito", sans-serif`
        ...
        this.resetTime.tryDraw = () =>
        {
            ...
            if(formatedTime !== this.resetTime.lastTimeDrawn)
            {
                ...
                this.resetTime.finalFormatedTime = formatedTime === '' ? '现在' : `${formatedTime}`
